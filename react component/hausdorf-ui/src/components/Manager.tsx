...
const Manager = ({ disabledInfo, disabledRating, streamer }: Props) => {
  ...
  return (
    <div className={clsx('videochat__row', client ? 'client' : 'online')}>
      ...
      <a href="#" className="videochat__camera">
